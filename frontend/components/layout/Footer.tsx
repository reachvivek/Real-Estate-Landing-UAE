        ...
        <div className="border-t border-border mt-8 pt-8 space-y-4">
          ...
          <div className="border-t border-border pt-4 text-center">
            <p className="text-sm text-muted-foreground mb-2">
              Developed by <span className="font-semibold text-foreground">Vivek Kumar Singh</span>
            </p>
            <p className="text-xs text-muted-foreground mb-2">
              Need a similar platform developed? Reach out to discuss your project
            </p>
            <div className="flex items-center justify-center gap-4 text-xs">
              <a href="mailto:rogerthatvivek@gmail.com" className="flex items-center gap-1 hover:text-foreground transition-colors">
                <Mail className="w-3 h-3" />
                <span>rogerthatvivek@gmail.com</span>
              </a>
