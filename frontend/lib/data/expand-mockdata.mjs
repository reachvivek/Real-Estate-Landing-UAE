...
const content = `export const mockProperties = [
  ...
  },
  {
    ...
    description: "Breathtaking ocean views from every room. High-end finishes and resort-style amenities.",
    agent: {
  ...
  },
  {
    ...
    description: "Modern high-rise living with premium amenities. Walk to restaurants and entertainment.",
    agent: {
      name: "Marcus Johnson",
  ...
  },
  {
    ...
    description: "Contemporary townhome in prime location. Walk to shops and Metro.",
    agent: {
      name: "Jennifer White",
      phone: "+1 (555) 567-8901",
      email: "jennifer@realestate.com",
  ...
  },
  {
    ...
    description: "Breathtaking penthouse with Las Vegas Strip views. Ultimate luxury living.",
    agent: {
      name: "Lisa Martinez",
      phone: "+1 (555) 901-2345",
      email: "lisa@realestate.com",
...
console.log('Successfully updated mockData.ts with 22 properties and 15 leads');
